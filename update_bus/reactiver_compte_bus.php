...
if(isset($_POST['valider'])){
  if(!empty($_POST['identifiant']) && !empty($_POST['mdp'])){
    ...
    $mdp = $_POST['mdp'];
    $req_user = $bdd->prepare("SELECT * FROM surho WHERE (mail = :identifiant OR phone =:identifiant) AND id = :id ");
    ...
    if($req_user->rowCount() > 0){
      ...
      $update_surho = $bdd->prepare("UPDATE surho SET statut = ? WHERE id = ?");
      $update_surho->execute(array($statut, $_SESSION['id']));
      header('location:console_reactivation_compte.php');
    }else{
...
<body>
  ...
  <main>
            ...
            <div class="col-8 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4" style="font-weight:900;">Résactivation Compte</h5>
                    <p class="text-center small">Veuillez fournir quelques informations pour résactiver votre compte</p>
                  </div>
    <?php if (isset($erreur)) : ?>
    ...
    <div class="row">
        ...
        <div class="col-12">
        <input type="submit" name="valider" class="btn btn-primary w-100" value="Résactiver mon compte">
        </div>
    </div>
    </form>
