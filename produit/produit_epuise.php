...
if(isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $recup_produit = $bdd->prepare("SELECT * FROM produit WHERE  (nom_produit LIKE :search OR description LIKE :search) AND quantite = 0 ORDER BY id_produit DESC");
    $recup_produit->execute(array(':search' => "%$search%"));
  } else {
    $recup_produit = $bdd->prepare("SELECT * FROM produit WHERE quantite = 0 ORDER BY id_produit DESC");
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Produits épuisés</h6>
