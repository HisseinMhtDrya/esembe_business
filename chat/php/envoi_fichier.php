    ...
    if(isset($_FILES['avatar']) AND !empty($_FILES['avatar']['name'])) {
        ...
        if(in_array($extensionUpload, $extensionsValides)) {
                ...
                if($resultat) {
                    ...
                    $updateavatar = $bdd->prepare('INSERT INTO messages(incoming_msg_id, outgoing_msg_id, msg, extension, msg_audio, date_message) VALUES(?, ?, ?, ?, ?, NOW() ) ');

                    $updateavatar->execute(array($incoming_id, $outgoing_id, $id_fichier.".".$extensionUpload, $extensionUpload, $msg_audio));
