              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <p class="text-center small">
                    <span style="color:#ff00ff;font-weight:bold;">Vous avez épuisé vos heures d'essai.
                  </p>
                  <p class="text-center">
                    Nous vous recommandons vivement de confirmer votre compte pour une meilleure expérience remplie d'opportunités infinies.
                    Pour ce, vous devez payer le frais d'abonnement fixé à <span style="color:#ff00ff;font-weight:bolder;">15$</span>. 
