...
$recup_vente_totale_jour = $bdd->prepare("SELECT SUM(montant_total) AS vente_totale FROM vente WHERE DATE(date_vente) = :today ");
$recup_vente_totale_jour->execute(array(':today' => $today));
$vente_totale = $recup_vente_totale_jour->fetch();
?>
<?php
          ...
          <div class="row justify-content-center">
           <div class="col-lg-12 col-md-12 align-items-center justify-content-center">
                        <div class="bg-white rounded h-100 p-4 table-responsive">
                            <h6 class="mb-4">Vente du jour <span class="text-primary"><?=$vente_totale['vente_totale']  ?> Fc</span></h6>
