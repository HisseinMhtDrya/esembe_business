            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4" style="font-weight:900;">Réactivation compte utilisateur</h5>
                    <p class="text-center small">Veuillez déclinper fournir quelques informations pour réactiver l'utilisateur</p>
                  </div>
                  <form role="form" method="POST" action="action_reactivation_compte_surho.php" class="registration-form row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Réactiver l'utilisateur</button>
                    </div>
                  </fieldset>    
                </form>
                </div>
