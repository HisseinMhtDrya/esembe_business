...
$depense = $bdd->prepare('SELECT * FROM depense ORDER BY id DESC');
$depense->execute();

$recup_depense_total = $bdd->prepare("SELECT sum(montant_depense) as montant_depense FROM depense");
$recup_depense_total->execute();
$montant_depense = $recup_depense_total->fetch();
        ...
        <div class="container">
          <div class="row justify-content-center">
           ...
           <div class="bg-white rounded h-100 p-4 table-responsive">
                            <h6 class="mb-4">Toutes les dépenses : <?=$montant_depense['montant_depense'] ?>Fc</h6>
