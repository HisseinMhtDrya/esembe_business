...
if(isset($_GET['search_query']) && !empty($_GET['search_query'])) {
   ...
   $commentaires = $bdd->prepare('SELECT * FROM commentaire WHERE expediteur LIKE :search_query OR commentaire LIKE :search_query ORDER BY id DESC');
...
<body>
                ...
                <div class="row vh-80 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-10 text-center p-4">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Listes des Topics</h6>
      ...
      <li style="list-style:none;">
                                <tr>
                                    ...
                                    <td>
          <a href="listes_message_admin.php?type=commentaire&supprime=<?= $c['id'] ?>" class="btn btn-primary">Supprimer</a></li>    
                                </tr>
                                 <?php } ?>
                                </tbody>
                            </table>
