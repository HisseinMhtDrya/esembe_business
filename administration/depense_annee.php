...
$depense = $bdd->prepare('SELECT * FROM depense WHERE YEAR(date_depense) = YEAR(CURDATE()) ORDER BY id DESC');
$depense->execute();
        ...
        <div class="container">
          <div class="row justify-content-center">
           ...
           <div class="bg-white rounded h-100 p-4 table-responsive">
                            <h6 class="mb-4">Dépense de l'année : <?=$montant_depense_annee['montant_depense_annee'] ?>Fc</h6>
