...
if (isset($_POST['code_validation'])) {
    ...
    $code_validation = htmlspecialchars($_POST['mdpconnect']);

    // Récupération des IDs des administrateurs et administratrices
    $sql_admin = $bdd->prepare("SELECT * FROM surho WHERE (type = 'Administrateur' OR type = 'Administratrice' 
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Envoi notification</p>
                  </div>
                  ...
                  <?php
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Code d'accès</label>
                    ...
                    <div class="col-12">
                    <input type="submit" class="btn btn-primary w-100" style="border-radius: 15px;" name="code_validation" value="Envoyer" class="btnLogin">
                    </div>
                  </form>
