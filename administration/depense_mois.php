...
$depense = $bdd->prepare('SELECT * FROM depense WHERE MONTH(date_depense) = MONTH(CURDATE()) ORDER BY id DESC');
$depense->execute();
        ...
        <div class="container">
          <div class="row justify-content-center">
           ...
           <div class="bg-white rounded h-100 p-4 table-responsive">
                            <h6 class="mb-4">Dépense du mois : <?=$montant_depense_mois['montant_depense_mois'] ?>Fc</h6>
